...
function crearGato(nombre, edad) {
   ...
   // Retornar el objeto.
   // Tu código:
   var gato = {nombre:nombre, edad:edad, meow(){return "Meow!"}};
   return gato;
...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   objetoUsuario.posts.forEach(objPost =>{
      suma = suma + objPost.likes;     
   });
...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   objetoProducto.calcularPrecioDescuento = function () {
      ...
      var descuentoTotal = objetoProducto.precio - descuento
